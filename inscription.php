	...
	if(!empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['password_two'])){
		...
		while($email_verification = $req->fetch()){
			if($email_verification['numberEmail'] != 0){
				header('location: inscription.php?error=1&message=Votre adress email est déjà utilisée par un autre utilisateur.');
				exit();
			}
		}
...
<head>
	...
	<link rel="icon" type="image/pngn" href="./imgs/favicon.png">
</head>
<body>
